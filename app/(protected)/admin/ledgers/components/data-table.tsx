    ...
    const onDelete = () => {
        if (confirm(`Are you sure you want to delete ${table.getFilteredSelectedRowModel().rows.length} leads?`)) {
            startTransition(async () => {
                const res = await deleteLedgers(table.getFilteredSelectedRowModel().rows.map(r => r.original.id));
                if (res.success) {
                    toast.success("Ledgers deleted");
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Add a new ledger to the system.
                            </DialogDescription>
                        </DialogHeader>
                        <LeadgerForm onSuccess={() => setOpen(false)} />
                    </DialogContent>
                </Dialog>
            </div>
